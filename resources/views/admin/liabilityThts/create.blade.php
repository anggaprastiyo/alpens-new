        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.liabilityTht.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.liability-thts.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('kps_jumlah_pns_baru') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="kps_jumlah_pns_baru" id="kps_jumlah_pns_baru" value="{{ old('kps_jumlah_pns_baru', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('kps_jumlah_peserta_aktif') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="kps_jumlah_peserta_aktif" id="kps_jumlah_peserta_aktif" value="{{ old('kps_jumlah_peserta_aktif', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('pensiun_iuran') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="pensiun_iuran" id="pensiun_iuran" value="{{ old('pensiun_iuran', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('pensiun_manfaat') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="pensiun_manfaat" id="pensiun_manfaat" value="{{ old('pensiun_manfaat', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('tht_iuran_tht') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tht_iuran_tht" id="tht_iuran_tht" value="{{ old('tht_iuran_tht', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('tht_iuran_si') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tht_iuran_si" id="tht_iuran_si" value="{{ old('tht_iuran_si', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('dwiguna_jumlah_klaim_pensiun') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="dwiguna_jumlah_klaim_pensiun" id="dwiguna_jumlah_klaim_pensiun" value="{{ old('dwiguna_jumlah_klaim_pensiun', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('dwiguna_jumlah_klaim_meninggal') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="dwiguna_jumlah_klaim_meninggal" id="dwiguna_jumlah_klaim_meninggal" value="{{ old('dwiguna_jumlah_klaim_meninggal', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('dwiguna_jumlah_klaim_keluar') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="dwiguna_jumlah_klaim_keluar" id="dwiguna_jumlah_klaim_keluar" value="{{ old('dwiguna_jumlah_klaim_keluar', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('dwiguna_jumlah_pembayaran_pensiun') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="dwiguna_jumlah_pembayaran_pensiun" id="dwiguna_jumlah_pembayaran_pensiun" value="{{ old('dwiguna_jumlah_pembayaran_pensiun', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('dwiguna_jumlah_pembayaran_meninggal') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="dwiguna_jumlah_pembayaran_meninggal" id="dwiguna_jumlah_pembayaran_meninggal" value="{{ old('dwiguna_jumlah_pembayaran_meninggal', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('dwiguna_jumlah_pembayaran_keluar') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="dwiguna_jumlah_pembayaran_keluar" id="dwiguna_jumlah_pembayaran_keluar" value="{{ old('dwiguna_jumlah_pembayaran_keluar', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('dwiguna_si_hp_pensiun') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="dwiguna_si_hp_pensiun" id="dwiguna_si_hp_pensiun" value="{{ old('dwiguna_si_hp_pensiun', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('dwiguna_si_hp_meninggal') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="dwiguna_si_hp_meninggal" id="dwiguna_si_hp_meninggal" value="{{ old('dwiguna_si_hp_meninggal', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('dwiguna_si_hp_keluar') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="dwiguna_si_hp_keluar" id="dwiguna_si_hp_keluar" value="{{ old('dwiguna_si_hp_keluar', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('askem_aktif_jumlah_klaim_pensiun') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="askem_aktif_jumlah_klaim_pensiun" id="askem_aktif_jumlah_klaim_pensiun" value="{{ old('askem_aktif_jumlah_klaim_pensiun', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('askem_aktif_jumlah_klaim_meninggal') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="askem_aktif_jumlah_klaim_meninggal" id="askem_aktif_jumlah_klaim_meninggal" value="{{ old('askem_aktif_jumlah_klaim_meninggal', '') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('askem_aktif_jumlah_klaim_keluar') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="askem_aktif_jumlah_klaim_keluar" id="askem_aktif_jumlah_klaim_keluar" value="{{ old('askem_aktif_jumlah_klaim_keluar', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('askem_aktif_jumlah_pembayaran_pensiun') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="askem_aktif_jumlah_pembayaran_pensiun" id="askem_aktif_jumlah_pembayaran_pensiun" value="{{ old('askem_aktif_jumlah_pembayaran_pensiun', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('askem_aktif_jumlah_pembayaran_meninggal') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="askem_aktif_jumlah_pembayaran_meninggal" id="askem_aktif_jumlah_pembayaran_meninggal" value="{{ old('askem_aktif_jumlah_pembayaran_meninggal', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('askem_aktif_jumlah_pembayaran_keluar') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="askem_aktif_jumlah_pembayaran_keluar" id="askem_aktif_jumlah_pembayaran_keluar" value="{{ old('askem_aktif_jumlah_pembayaran_keluar', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('askem_pensiun_jumlah_klaim_pensiun') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="askem_pensiun_jumlah_klaim_pensiun" id="askem_pensiun_jumlah_klaim_pensiun" value="{{ old('askem_pensiun_jumlah_klaim_pensiun', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('askem_pensiun_jumlah_klaim_meninggal') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="askem_pensiun_jumlah_klaim_meninggal" id="askem_pensiun_jumlah_klaim_meninggal" value="{{ old('askem_pensiun_jumlah_klaim_meninggal', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('askem_pensiun_jumlah_klaim_keluar') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="askem_pensiun_jumlah_klaim_keluar" id="askem_pensiun_jumlah_klaim_keluar" value="{{ old('askem_pensiun_jumlah_klaim_keluar', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('askem_pensiun_jumlah_pembayaran_pensiun') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="askem_pensiun_jumlah_pembayaran_pensiun" id="askem_pensiun_jumlah_pembayaran_pensiun" value="{{ old('askem_pensiun_jumlah_pembayaran_pensiun', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('askem_pensiun_jumlah_pembayaran_meninggal') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="askem_pensiun_jumlah_pembayaran_meninggal" id="askem_pensiun_jumlah_pembayaran_meninggal" value="{{ old('askem_pensiun_jumlah_pembayaran_meninggal', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('askem_pensiun_jumlah_pembayaran_keluar') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="askem_pensiun_jumlah_pembayaran_keluar" id="askem_pensiun_jumlah_pembayaran_keluar" value="{{ old('askem_pensiun_jumlah_pembayaran_keluar', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('total_manfaat') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="total_manfaat" id="total_manfaat" value="{{ old('total_manfaat', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('kmpmd_asuransi_dwiguna') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="kmpmd_asuransi_dwiguna" id="kmpmd_asuransi_dwiguna" value="{{ old('kmpmd_asuransi_dwiguna', '') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('kmpmd_asuransi_kematian') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="kmpmd_asuransi_kematian" id="kmpmd_asuransi_kematian" value="{{ old('kmpmd_asuransi_kematian', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('kenaikan_kmpmd') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="kenaikan_kmpmd" id="kenaikan_kmpmd" value="{{ old('kenaikan_kmpmd', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('liabilitas') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="liabilitas" id="liabilitas" value="{{ old('liabilitas', '') }}" step="0.01" required>
