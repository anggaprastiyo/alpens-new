        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.generalAssumption.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.general-assumptions.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('version_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="version_name" id="version_name" value="{{ old('version_name', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('tahun_awal_proyeksi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tahun_awal_proyeksi" id="tahun_awal_proyeksi" value="{{ old('tahun_awal_proyeksi', '') }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('tahun_akhir_proyeksi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tahun_akhir_proyeksi" id="tahun_akhir_proyeksi" value="{{ old('tahun_akhir_proyeksi', '') }}" step="1" required>
                        ...
                        <div class="form-group {{ $errors->has('pajak_atas_kupon_obligasi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="pajak_atas_kupon_obligasi" id="pajak_atas_kupon_obligasi" value="{{ old('pajak_atas_kupon_obligasi', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('pajak_atas_bunga_deposito') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="pajak_atas_bunga_deposito" id="pajak_atas_bunga_deposito" value="{{ old('pajak_atas_bunga_deposito', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('kenaikan_bop_pertahun') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="kenaikan_bop_pertahun" id="kenaikan_bop_pertahun" value="{{ old('kenaikan_bop_pertahun', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('spread_yoi_untuk_si') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="spread_yoi_untuk_si" id="spread_yoi_untuk_si" value="{{ old('spread_yoi_untuk_si', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('counter_rate') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="counter_rate" id="counter_rate" value="{{ old('counter_rate', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('spread_counter_rate') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="spread_counter_rate" id="spread_counter_rate" value="{{ old('spread_counter_rate', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('tenor_saham') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tenor_saham" id="tenor_saham" value="{{ old('tenor_saham', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('tenor_reksadana') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tenor_reksadana" id="tenor_reksadana" value="{{ old('tenor_reksadana', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('tenor_inv_langsung') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tenor_inv_langsung" id="tenor_inv_langsung" value="{{ old('tenor_inv_langsung', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('capital_gain_saham') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="capital_gain_saham" id="capital_gain_saham" value="{{ old('capital_gain_saham', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('capital_gain_reksadana') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="capital_gain_reksadana" id="capital_gain_reksadana" value="{{ old('capital_gain_reksadana', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('capital_gain_inv_langsung') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="capital_gain_inv_langsung" id="capital_gain_inv_langsung" value="{{ old('capital_gain_inv_langsung', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('capital_gain_rdpt') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="capital_gain_rdpt" id="capital_gain_rdpt" value="{{ old('capital_gain_rdpt', '') }}" step="0.01" required>
