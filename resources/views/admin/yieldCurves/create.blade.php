        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.yieldCurve.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.yield-curves.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('source_file') ? 'has-error' : '' }}">
                            <label for="source_file">{{ trans('cruds.yieldCurve.fields.source_file') }}</label>
