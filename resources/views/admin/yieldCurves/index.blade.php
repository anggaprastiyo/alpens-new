                                    ...
                                    <tr data-entry-id="{{ $yieldCurve->id }}">
                                        ...
                                        <td>
                                            @can('yield_curve_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('admin.yield-curve-details.index', ['id' => $yieldCurve->id]) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan
                                            ...
                                            @can('yield_curve_delete')
                                                <form action="{{ route('admin.yield-curves.destroy', $yieldCurve->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');"
