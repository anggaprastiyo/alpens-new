                            ...
                            <table class=" table table-bordered table-striped table-hover datatable datatable-DataSap">
                                ...
                                @foreach($dataSaps as $key => $dataSap)
                                    <tr data-entry-id="{{ $dataSap->id }}">
                                        ...
                                        <td>
                                            @can('data_sap_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('admin.data-sap-details.index', ['id' => $dataSap->id]) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan
                                            ...
                                            @can('data_sap_delete')
                                                <form action="{{ route('admin.data-saps.destroy', $dataSap->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');"
