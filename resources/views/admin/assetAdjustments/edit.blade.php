                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.asset-adjustments.update", [$assetAdjustment->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('portfolio_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="portfolio_date" id="portfolio_date" value="{{ old('portfolio_date', $assetAdjustment->portfolio_date) }}">
                        ...
                        <div class="form-group {{ $errors->has('tipe_asset') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="tipe_asset" id="tipe_asset" value="{{ old('tipe_asset', $assetAdjustment->tipe_asset) }}">
                        ...
                        <div class="form-group {{ $errors->has('program') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="program" id="program" value="{{ old('program', $assetAdjustment->program) }}">
                        ...
                        <div class="form-group {{ $errors->has('level_1') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="level_1" id="level_1" value="{{ old('level_1', $assetAdjustment->level_1) }}">
                        ...
                        <div class="form-group {{ $errors->has('level_2') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="level_2" id="level_2" value="{{ old('level_2', $assetAdjustment->level_2) }}">
                        ...
                        <div class="form-group {{ $errors->has('level_3') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="level_3" id="level_3" value="{{ old('level_3', $assetAdjustment->level_3) }}">
                        ...
                        <div class="form-group {{ $errors->has('ticker') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="ticker" id="ticker" value="{{ old('ticker', $assetAdjustment->ticker) }}">
                        ...
                        <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $assetAdjustment->name) }}">
                            @if($errors->has('name'))
                        ...
                        <div class="form-group {{ $errors->has('nama_bank') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nama_bank" id="nama_bank" value="{{ old('nama_bank', $assetAdjustment->nama_bank) }}">
                        ...
                        <div class="form-group {{ $errors->has('nomor_bilyet') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nomor_bilyet" id="nomor_bilyet" value="{{ old('nomor_bilyet', $assetAdjustment->nomor_bilyet) }}">
                        ...
                        <div class="form-group {{ $errors->has('nama_mi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nama_mi" id="nama_mi" value="{{ old('nama_mi', $assetAdjustment->nama_mi) }}">
                        ...
                        <div class="form-group {{ $errors->has('rating') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="rating" id="rating" value="{{ old('rating', $assetAdjustment->rating) }}">
                        ...
                        <div class="form-group {{ $errors->has('tanggal_perolehan') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="tanggal_perolehan" id="tanggal_perolehan" value="{{ old('tanggal_perolehan', $assetAdjustment->tanggal_perolehan) }}">
                        ...
                        <div class="form-group {{ $errors->has('tanggal_maturity') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="tanggal_maturity" id="tanggal_maturity" value="{{ old('tanggal_maturity', $assetAdjustment->tanggal_maturity) }}">
                        ...
                        <div class="form-group {{ $errors->has('nilai_perolehan') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="nilai_perolehan" id="nilai_perolehan" value="{{ old('nilai_perolehan', $assetAdjustment->nilai_perolehan) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('harga_perolehan') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="harga_perolehan" id="harga_perolehan" value="{{ old('harga_perolehan', $assetAdjustment->harga_perolehan) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('kupon') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="kupon" id="kupon" value="{{ old('kupon', $assetAdjustment->kupon) }}" step="0.01">
                            @if($errors->has('kupon'))
                        ...
                        <div class="form-group {{ $errors->has('pembagian_kupon') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="pembagian_kupon" id="pembagian_kupon" value="{{ old('pembagian_kupon', $assetAdjustment->pembagian_kupon) }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('bunga') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="bunga" id="bunga" value="{{ old('bunga', $assetAdjustment->bunga) }}" step="0.01">
                            @if($errors->has('bunga'))
                        ...
                        <div class="form-group {{ $errors->has('pembagian_bunga') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="pembagian_bunga" id="pembagian_bunga" value="{{ old('pembagian_bunga', $assetAdjustment->pembagian_bunga) }}">
                        ...
                        <div class="form-group {{ $errors->has('harga_pasar') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="harga_pasar" id="harga_pasar" value="{{ old('harga_pasar', $assetAdjustment->harga_pasar) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('nilai_pasar') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="nilai_pasar" id="nilai_pasar" value="{{ old('nilai_pasar', $assetAdjustment->nilai_pasar) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('nilai_tercatat') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="nilai_tercatat" id="nilai_tercatat" value="{{ old('nilai_tercatat', $assetAdjustment->nilai_tercatat) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('potential') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="potential" id="potential" value="{{ old('potential', $assetAdjustment->potential) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('lembar_saham') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="lembar_saham" id="lembar_saham" value="{{ old('lembar_saham', $assetAdjustment->lembar_saham) }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('deviden_saham') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="deviden_saham" id="deviden_saham" value="{{ old('deviden_saham', $assetAdjustment->deviden_saham) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('pembagian_deviden_saham') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="pembagian_deviden_saham" id="pembagian_deviden_saham" value="{{ old('pembagian_deviden_saham', $assetAdjustment->pembagian_deviden_saham) }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('market_cap_saham') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="market_cap_saham" id="market_cap_saham" value="{{ old('market_cap_saham', $assetAdjustment->market_cap_saham) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('unit_penyertaan') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="unit_penyertaan" id="unit_penyertaan" value="{{ old('unit_penyertaan', $assetAdjustment->unit_penyertaan) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('nab') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="nab" id="nab" value="{{ old('nab', $assetAdjustment->nab) }}" step="0.01">
                            @if($errors->has('nab'))
                        ...
                        <div class="form-group {{ $errors->has('time_to_maturity') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="time_to_maturity" id="time_to_maturity" value="{{ old('time_to_maturity', $assetAdjustment->time_to_maturity) }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('yield_to_maturity') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="yield_to_maturity" id="yield_to_maturity" value="{{ old('yield_to_maturity', $assetAdjustment->yield_to_maturity) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('faktor_pengurang') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="faktor_pengurang" id="faktor_pengurang" value="{{ old('faktor_pengurang', $assetAdjustment->faktor_pengurang) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('tenor') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tenor" id="tenor" value="{{ old('tenor', $assetAdjustment->tenor) }}" step="0.01">
                            @if($errors->has('tenor'))
                        ...
                        <div class="form-group {{ $errors->has('sisa_tenor') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="sisa_tenor" id="sisa_tenor" value="{{ old('sisa_tenor', $assetAdjustment->sisa_tenor) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('macaulay_duration') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="macaulay_duration" id="macaulay_duration" value="{{ old('macaulay_duration', $assetAdjustment->macaulay_duration) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('modified_duration') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="modified_duration" id="modified_duration" value="{{ old('modified_duration', $assetAdjustment->modified_duration) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('convexity_apporximation') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="convexity_apporximation" id="convexity_apporximation" value="{{ old('convexity_apporximation', $assetAdjustment->convexity_apporximation) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('bobot_macaulay_duration') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="bobot_macaulay_duration" id="bobot_macaulay_duration" value="{{ old('bobot_macaulay_duration', $assetAdjustment->bobot_macaulay_duration) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('bobot_modified_duration') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="bobot_modified_duration" id="bobot_modified_duration" value="{{ old('bobot_modified_duration', $assetAdjustment->bobot_modified_duration) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('bobot_convexity_apporximation') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="bobot_convexity_apporximation" id="bobot_convexity_apporximation" value="{{ old('bobot_convexity_apporximation', $assetAdjustment->bobot_convexity_apporximation) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('tanggal_saldo_awal') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="tanggal_saldo_awal" id="tanggal_saldo_awal" value="{{ old('tanggal_saldo_awal', $assetAdjustment->tanggal_saldo_awal) }}">
                        ...
                        <div class="form-group {{ $errors->has('tanggal_add_set_modal') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="tanggal_add_set_modal" id="tanggal_add_set_modal" value="{{ old('tanggal_add_set_modal', $assetAdjustment->tanggal_add_set_modal) }}">
                        ...
                        <div class="form-group {{ $errors->has('nilai_investasi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="nilai_investasi" id="nilai_investasi" value="{{ old('nilai_investasi', $assetAdjustment->nilai_investasi) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('pelunasan_shl') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="pelunasan_shl" id="pelunasan_shl" value="{{ old('pelunasan_shl', $assetAdjustment->pelunasan_shl) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('tambahan_setoran_modal') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tambahan_setoran_modal" id="tambahan_setoran_modal" value="{{ old('tambahan_setoran_modal', $assetAdjustment->tambahan_setoran_modal) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('div_yield_bunga') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="div_yield_bunga" id="div_yield_bunga" value="{{ old('div_yield_bunga', $assetAdjustment->div_yield_bunga) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('pembagian_div_yield_bunga') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="pembagian_div_yield_bunga" id="pembagian_div_yield_bunga" value="{{ old('pembagian_div_yield_bunga', $assetAdjustment->pembagian_div_yield_bunga) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('projected_add_yield') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="projected_add_yield" id="projected_add_yield" value="{{ old('projected_add_yield', $assetAdjustment->projected_add_yield) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('divestasi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="divestasi" id="divestasi" value="{{ old('divestasi', $assetAdjustment->divestasi) }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('tanggal_divestasi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="tanggal_divestasi" id="tanggal_divestasi" value="{{ old('tanggal_divestasi', $assetAdjustment->tanggal_divestasi) }}">
                        ...
                        <div class="form-group {{ $errors->has('harga_perolehan_divestasi') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="harga_perolehan_divestasi" id="harga_perolehan_divestasi" value="{{ old('harga_perolehan_divestasi', $assetAdjustment->harga_perolehan_divestasi) }}" step="0.01">
