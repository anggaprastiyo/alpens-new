        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.edit') }} {{ trans('cruds.liabilityPensiun.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.liability-pensiuns.update", [$liabilityPensiun->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group {{ $errors->has('liability_portofolio') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="liability_portofolio_id" id="liability_portofolio_id" required>
                                @foreach($liability_portofolios as $id => $entry)
                                    <option value="{{ $id }}" {{ (old('liability_portofolio_id') ? old('liability_portofolio_id') : $liabilityPensiun->liability_portofolio->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('report_date') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="report_date" id="report_date" value="{{ old('report_date', $liabilityPensiun->report_date) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('skenario') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="skenario" id="skenario" value="{{ old('skenario', $liabilityPensiun->skenario) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('tahun') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="tahun" id="tahun" value="{{ old('tahun', $liabilityPensiun->tahun) }}" step="1" required>
                            @if($errors->has('tahun'))
                        ...
                        <div class="form-group {{ $errors->has('peserta_pensiun') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="peserta_pensiun" id="peserta_pensiun" value="{{ old('peserta_pensiun', $liabilityPensiun->peserta_pensiun) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('iuran') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="iuran" id="iuran" value="{{ old('iuran', $liabilityPensiun->iuran) }}" step="0.01" required>
                            @if($errors->has('iuran'))
                        ...
                        <div class="form-group {{ $errors->has('spppip') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="spppip" id="spppip" value="{{ old('spppip', $liabilityPensiun->spppip) }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('pembayaran_manfaat') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="pembayaran_manfaat" id="pembayaran_manfaat" value="{{ old('pembayaran_manfaat', $liabilityPensiun->pembayaran_manfaat) }}" step="0.01" required>
