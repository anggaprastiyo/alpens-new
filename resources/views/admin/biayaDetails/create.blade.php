        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.biayaDetail.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.biaya-details.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('biaya') ? 'has-error' : '' }}">
                            <label class="required" for="biaya_id">{{ trans('cruds.biayaDetail.fields.biaya') }}</label>
                            ...
                            @endif
                            <span class="help-block">{{ trans('cruds.biayaDetail.fields.biaya_helper') }}</span>
                        </div>
                        ...
                        <div class="form-group {{ $errors->has('iuran') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="iuran" id="iuran" value="{{ old('iuran', '') }}" step="0.01">
                            @if($errors->has('iuran'))
                        ...
                        <div class="form-group {{ $errors->has('bop') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="bop" id="bop" value="{{ old('bop', '') }}" step="0.01">
                            @if($errors->has('bop'))
                        ...
                        <div class="form-group {{ $errors->has('biaya_operasional') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="biaya_operasional" id="biaya_operasional" value="{{ old('biaya_operasional', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('rkap_iuran') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="rkap_iuran" id="rkap_iuran" value="{{ old('rkap_iuran', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('rkap_bop') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="rkap_bop" id="rkap_bop" value="{{ old('rkap_bop', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('rkap_biaya_operasional') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="rkap_biaya_operasional" id="rkap_biaya_operasional" value="{{ old('rkap_biaya_operasional', '') }}" step="0.01" required>
