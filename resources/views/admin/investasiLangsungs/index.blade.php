        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-InvestasiLangsung">
                        <thead>
                            <tr>
                                <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.investasi-langsungs.index') }}",
    columns: [
...
{ data: 'nilai_investasi', name: 'nilai_investasi' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-InvestasiLangsung').DataTable(dtOverrideGlobals);
