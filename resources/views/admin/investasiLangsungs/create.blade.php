        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.investasiLangsung.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.investasi-langsungs.store") }}" enctype="multipart/form-data">
                        @csrf
