        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.priceHistorical.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.price-historicals.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group {{ $errors->has('isin') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="isin" id="isin" value="{{ old('isin', '') }}" required>
                            @if($errors->has('isin'))
                        ...
                        <div class="form-group {{ $errors->has('fair_yield') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="fair_yield" id="fair_yield" value="{{ old('fair_yield', '') }}" step="0.01" required>
                        ...
                        <div class="form-group {{ $errors->has('fair_price') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="fair_price" id="fair_price" value="{{ old('fair_price', '') }}" step="0.01" required>
