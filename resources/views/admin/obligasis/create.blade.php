        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    {{ trans('global.create') }} {{ trans('cruds.obligasi.title_singular') }}
                </div>
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.obligasis.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group {{ $errors->has('asset_migration') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control select2" name="asset_migration_id" id="asset_migration_id" required>
                                @foreach($asset_migrations as $id => $entry)
                                    <option value="{{ $id }}" {{ old('asset_migration_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('program') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="program" id="program" required>
                                ...
                                @foreach(App\Models\Obligasi::PROGRAM_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('program', 'AIP') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('tanggal_perolehan') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="tanggal_perolehan" id="tanggal_perolehan" value="{{ old('tanggal_perolehan') }}">
                        ...
                        <div class="form-group {{ $errors->has('tanggal_maturity') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="tanggal_maturity" id="tanggal_maturity" value="{{ old('tanggal_maturity') }}">
                        ...
                        <div class="form-group {{ $errors->has('pembagian_kupon') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="pembagian_kupon" id="pembagian_kupon" value="{{ old('pembagian_kupon', '') }}" step="0.01">
                        ...
                        <div class="form-group {{ $errors->has('last_edited_by') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="last_edited_by" id="last_edited_by" value="{{ old('last_edited_by', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('is_updated') ? 'has-error' : '' }}">
                            <div>
                                ...
                                <input type="checkbox" name="is_updated" id="is_updated" value="1" {{ old('is_updated', 0) == 1 ? 'checked' : '' }}>
