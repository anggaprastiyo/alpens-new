                            ...
                            <table class=" table table-bordered table-striped table-hover datatable datatable-Biaya">
                                ...
                                @foreach($biayas as $key => $biaya)
                                    <tr data-entry-id="{{ $biaya->id }}">
                                        ...
                                        <td>
                                            @can('biaya_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('admin.biaya-details.index', ['id' => $biaya->id]) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan
                                            ...
                                            @can('biaya_delete')
                                                <form action="{{ route('admin.biayas.destroy', $biaya->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');"
