            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        {{ trans('global.create') }} {{ trans('cruds.yieldCurveDetail.title_singular') }}
                    </div>
                    <div class="panel-body">
                        <form method="POST" action="{{ route("admin.yield-curve-details.store") }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group {{ $errors->has('tenor_year') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="number" name="tenor_year" id="tenor_year" value="{{ old('tenor_year', '') }}" step="0.01">
                            ...
                            <div class="form-group {{ $errors->has('today') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="number" name="today" id="today" value="{{ old('today', '') }}" step="0.01" required>
                                @if($errors->has('today'))
                            ...
                            <div class="form-group {{ $errors->has('change_bps') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="number" name="change_bps" id="change_bps" value="{{ old('change_bps', '') }}" step="0.01" required>
                            ...
                            <div class="form-group {{ $errors->has('yesterday_yield') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="number" name="yesterday_yield" id="yesterday_yield" value="{{ old('yesterday_yield', '') }}" step="0.01" required>
                            ...
                            <div class="form-group {{ $errors->has('lastweek_yield') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="number" name="lastweek_yield" id="lastweek_yield" value="{{ old('lastweek_yield', '') }}" step="0.01" required>
                            ...
                            <div class="form-group {{ $errors->has('lastmonth_yield') ? 'has-error' : '' }}">
                                ...
                                <input class="form-control" type="number" name="lastmonth_yield" id="lastmonth_yield" value="{{ old('lastmonth_yield', '') }}" step="0.01" required>
