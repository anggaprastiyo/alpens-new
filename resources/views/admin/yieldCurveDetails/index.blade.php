    ...
    <div class="content">
        @can('yield_curve_detail_create')
            <div style="margin-bottom: 10px;" class="row">
                <div class="col-lg-12">
                    <a class="btn btn-success" href="{{ route('admin.yield-curve-details.create', ['id' => $yieldCurve->id]) }}">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        {{ trans('cruds.yieldCurveDetail.title_singular') }} {{ trans('global.list') }} | <b>{{ $yieldCurve->version_name }} - ID = {{ $yieldCurve->id }}</b>
                    </div>
                                    ...
                                    <tr data-entry-id="{{ $yieldCurveDetail->id }}">
                                        ...
                                        <td>
                                            ...
                                            @can('yield_curve_detail_delete')
                                                <form action="{{ route('admin.yield-curve-details.destroy', $yieldCurveDetail->id) }}" method="POST"
